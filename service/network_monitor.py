...
def monitor_network_forever():
    ...
    # used as a latch so that when this app starts up, we don't incorrectly notify that all devices
    # are newly connected 
    ...
    while True:
        ...
        if len(devices_requiring_notification) > 0 and skip_notification == False:
